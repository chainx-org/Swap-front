...
export default function TabCoinSelect({
  className = "",
  optionList,
  isShow,
  coinSymol,
  ShowSelect,
  currCoin,
}: CoinSelectProps): React.ReactElement<CoinSelectProps> {
  return (
...
const Wrapper = styled.div`
  ...
  .currContent {
    ...
    align-items: center;
    background: #efefef;
    box-shadow: -2px -2px 3px 0 rgba(0, 0, 0, 0.1), 2px 2px 3px 0 #ffffff;
    border-radius: 15px;
    width: 153px;
    height: 40px;
    .currName {
